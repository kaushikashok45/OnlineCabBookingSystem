  ...
  <html>
    ...
    <h1>Ashok Cabs</h1>
       ...
       <div id="confirmbox">
        ...
        <h2 class="cancellation">Error 301!</h2>
        <h3 class="details">Sorry,that's not right.</h3>
        <p id="subs">The page you have requested might have been permanently moved to a new domain.</p>
        <div id="btns">
           <div id="start">
